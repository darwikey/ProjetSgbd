...
\section{Joueurs}
Dans l'onglet 'Joueurs', on affiche chaque joueur avec des informations comme son nom, prénom, numéro de licence... On calcule aussi la moyenne des points marqués et des fautes faites, ainsi que leur écart type.
...
La ligne '\textit{and Year(a.Date\_match) = Year(Now())}' permet de selectionner seulement les matchs se déroulant pendant la saison courante.
