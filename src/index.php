...
<a href="index.php?page=club">Clubs</a> | <a href="index.php?page=equipe">Équipes</a> | <a href="index.php?page=joueur">Joueurs</a>
 | <a href="index.php?page=match">Matchs</a> | <a href="index.php?page=statistique">Statistiques</a> | <a href="index.php?page=ajouter">Ajouter</a> | <a href="index.php?page=modifier">Modifier</a> 
 </p></div>
